    ...
    layout_main = [
        ...
        sg.Frame('',[
            ...
            [
                ...
                [sg.Text('',font=('Helvetica',60),justification='center', key='time_cam2',expand_x=True, expand_y=True)],
        ...
        sg.Frame('',[
            ...
            [
                ...
                [sg.Text('',font=('Helvetica',60), justification='center', key='time_cam1',expand_x=True, expand_y=True)],
            ], vertical_alignment='top',size=(520,250),expand_x=True, expand_y=True),
            sg.Frame('',[
                #[sg.Text('')],
