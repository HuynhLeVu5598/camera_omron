...
def save_param_model1(conf,nut_me,divat,me,namchamcao,traybactruc,divatduoi,kimnamcham):
    line1 = 'conf1' + ':' + str(conf)
    line2 = 'nut_me1' + ':' + str(nut_me)
    line3 = 'divat1' + ':' + str(divat)
    line4 = 'me1' + ':' + str(me)
    line5 = 'namchamcao1' + ':' + str(namchamcao)
    line6 = 'traybactruc1' + ':' + str(traybactruc)
    line7 = 'divatduoi1' + ':' + str(divatduoi)
    line8 = 'kimnamcham1' + ':' + str(kimnamcham)
...
def save_param_model2(conf,nut_me,divat,me):
    line1 = 'conf' + ':' + str(conf)
...
def set_exposure_or_gain(node_name,node_name1,value):
    if remote_nodemap1.get_node(node_name):
        node = remote_nodemap1.get_node(node_name)
        ...
        node1 = remote_nodemap1.get_node(node_name1)
...
def set_config_init_camera1():
    ...
    set_exposure_or_gain("ExposureTime","ExposureTimeRaw",list_param_camera1[0])
    set_exposure_or_gain("Gain","GainRaw",list_param_camera1[1])
...
def set_config_init_camera2():
    ...
    set_exposure_or_gain("ExposureTime","ExposureTimeRaw",list_param_camera2[0])
    set_exposure_or_gain("Gain","GainRaw",list_param_camera2[1])
...
def save_param_camera(v1,v2,v3,v4,v5,v6,v7,filename):
...
def task_camera1_no_plc(model,size,conf):
    if event =='Snap1': 
        t1 = time.time()
...
def task_camera2_no_plc(model,size,conf):
    if event =='Snap2': 
...
def make_window(theme):
    ...
    layout_parameter_model = [
        ...
        sg.Frame('',[
            [sg.Frame('',
            [
                [sg.Text('Weights', size=(12,1), font=('Helvetica',15),text_color='yellow'), sg.Input(size=(52,1), font=('Helvetica',12), key='file_weights2',readonly= True, text_color='navy',enable_events= True),
                sg.Frame('',[
                    [sg.FileBrowse(file_types= file_weights, size=(12,1), font=('Helvetica',10),key= 'file_browse2',enable_events=True, disabled=True)]
                ], relief= sg.RELIEF_FLAT)],
                [sg.Text('Size', size=(12,1),font=('Helvetica',15), text_color='yellow'),sg.InputCombo((416,512,608,896,1024,1280,1408,1536),size=(56,20),font=('Helvetica',11),disabled=True,default_value=416,key='imgsz2')],
                [sg.Text('Confidence',size=(12,1),font=('Helvetica',15), text_color='yellow'), sg.Slider(range=(1,100),orientation='h',size=(52,20),font=('Helvetica',11),disabled=True,default_value=list_param_model2[0], key= 'conf_thres2')],
                [sg.Text('Nut me',size=(12,1),font=('Helvetica',15), text_color='yellow'), sg.Slider(range=(1,8000),orientation='h',size=(52,20),font=('Helvetica',11),disabled=True,default_value=list_param_model2[1], resolution=5, key= 'area_nutme2')],
                [sg.Text('Di vat',size=(12,1),font=('Helvetica',15), text_color='yellow'), sg.Slider(range=(1,8000),orientation='h',size=(52,20),font=('Helvetica',11),disabled=True,default_value=list_param_model2[2], resolution=5, key= 'area_divat2')],
                [sg.Text('Me',size=(12,1),font=('Helvetica',15), text_color='yellow'), sg.Slider(range=(1,8000),orientation='h',size=(52,20),font=('Helvetica',11),disabled=True ,default_value=list_param_model2[3], resolution=5, key= 'area_me2')],
        ...
        sg.Frame('',[
            [sg.Frame('',
            [
                [sg.Text('Weights', size=(12,1), font=('Helvetica',15),text_color='yellow'), sg.Input(size=(52,1), font=('Helvetica',12), key='file_weights1',readonly= True, text_color='navy',enable_events= True),
                sg.Frame('',[
                    [sg.FileBrowse(file_types= file_weights, size=(12,1), font=('Helvetica',10),key= 'file_browse1',enable_events=True,disabled=True )]
                ], relief= sg.RELIEF_FLAT)],
                [sg.Text('Size', size=(12,1),font=('Helvetica',15), text_color='yellow'),sg.InputCombo((416,512,608,896,1024,1280,1408,1536),size=(56,20),font=('Helvetica',11),disabled=True ,default_value=416,key='imgsz1')],
                [sg.Text('Confidence',size=(12,1),font=('Helvetica',15), text_color='yellow'), sg.Slider(range=(1,100),orientation='h',size=(52,20),font=('Helvetica',11),disabled=True  ,default_value=list_param_model1[0], key= 'conf_thres1')],
                [sg.Text('Nut me',size=(12,1),font=('Helvetica',15), text_color='yellow'), sg.Slider(range=(1,4000),orientation='h',size=(52,20),font=('Helvetica',11), disabled=True ,default_value=list_param_model1[1], resolution=5, key= 'area_nutme1')],
                [sg.Text('Di vat',size=(12,1),font=('Helvetica',15), text_color='yellow'), sg.Slider(range=(1,4000),orientation='h',size=(52,20),font=('Helvetica',11), disabled=True ,default_value=list_param_model1[2], resolution=5, key= 'area_divat1')],
                [sg.Text('Me',size=(12,1),font=('Helvetica',15), text_color='yellow'), sg.Slider(range=(1,4000),orientation='h',size=(52,20),font=('Helvetica',11), disabled=True ,default_value=list_param_model1[3], resolution=5, key= 'area_me1')],
                [sg.Text('Nam cham cao',size=(12,1),font=('Helvetica',15), text_color='yellow'), sg.Slider(range=(1,200),orientation='h',size=(52,20),font=('Helvetica',11), disabled=True ,default_value=list_param_model1[4], resolution=1, key= 'y_namchamcao1')],
                [sg.Text('Tray bac truc',size=(12,1),font=('Helvetica',15), text_color='yellow'), sg.Slider(range=(1,4000),orientation='h',size=(52,20),font=('Helvetica',11), disabled=True ,default_value=list_param_model1[5], resolution=5, key= 'area_traybactruc1')],
                [sg.Text('Di vat duoi',size=(12,1),font=('Helvetica',15), text_color='yellow'), sg.Slider(range=(1,4000),orientation='h',size=(52,20),font=('Helvetica',11), disabled=True ,default_value=list_param_model1[6], resolution=5, key= 'area_divatduoi1')],
                [sg.Text('Kim nam cham',size=(12,1),font=('Helvetica',15), text_color='yellow'), sg.Slider(range=(1,200),orientation='h',size=(52,20),font=('Helvetica',11), disabled=True ,default_value=list_param_model1[7], resolution=1, key= 'y_kimnamcham1')]
                #[sg.Text('Result1',size=(12,5),font=('Helvetica',15),text_color='yellow',expand_y =True),sg.InputText('',size=(16,5),justification='center',font=('Helvetica',30),text_color='red',readonly=True, key='result1',expand_y=True)]
            ]),
            ]
        ], expand_y= True),
    ...
    layout_parameter_camera1 = [
        [sg.Text('Exposure',size=(10,1),font=('Helvetica',15), text_color='yellow'),
            sg.Input(default_text=list_param_camera1[0],size=(10,1),font=('Helvetica',12),key='exposure_input1',text_color='navy',enable_events=True),
            sg.Slider(range=(1,16777215),resolution=1,orientation='h',size=(40,20),font=('Helvetica',11), default_value=list_param_camera1[0], key= 'exposure_slider1', enable_events=True),
            sg.Button('OK', size=(8,1),  font=('Helvetica',10),key='choose_exposure1',enable_events=True)
            ],
        [sg.Text('')],
        [sg.Text('Gain',size=(10,1),font=('Helvetica',15), text_color='yellow'),
            sg.Input(default_text=list_param_camera1[1],size=(10,1),font=('Helvetica',12),key='gain_input1',text_color='navy',enable_events=True),
            sg.Slider(range=(0,208),orientation='h',size=(40,20),font=('Helvetica',11), default_value=list_param_camera1[1], key= 'gain_slider1', enable_events=True),
            sg.Button('OK', size=(8,1),  font=('Helvetica',10),key='choose_gain1',enable_events=True)
            ],
        [sg.Text('')],
        ...
        [sg.Text(' ')],
        [sg.Text(' '*110), sg.Button('Apply', size=(10,1),  font=('Helvetica',12),key='aplly_param_camera1',enable_events=True),sg.Button('Save', size=(10,1),  font=('Helvetica',12),key='save_param_camera1',enable_events=True)] 
    ] 

    # parameter camera 2
    layout_parameter_camera2 = [
        [sg.Text('Exposure',size=(10,1),font=('Helvetica',15), text_color='yellow'),
            sg.Input(default_text=list_param_camera2[0],size=(10,1),font=('Helvetica',12),key='exposure_input2',text_color='navy',enable_events=True),
            sg.Slider(range=(1,16777215),resolution=1,orientation='h',size=(40,20),font=('Helvetica',11), default_value=list_param_camera2[0], key= 'exposure_slider2', enable_events=True),
            sg.Button('OK', size=(8,1),  font=('Helvetica',10),key='choose_exposure1',enable_events=True)
            ],
        [sg.Text('')],
        [sg.Text('Gain',size=(10,1),font=('Helvetica',15), text_color='yellow'),
            sg.Input(default_text=list_param_camera2[1],size=(10,1),font=('Helvetica',12),key='gain_input2',text_color='navy',enable_events=True),
            sg.Slider(range=(0,208),orientation='h',size=(40,20),font=('Helvetica',11), default_value=list_param_camera2[1], key= 'gain_slider2', enable_events=True),
            sg.Button('OK', size=(8,1),  font=('Helvetica',10),key='choose_gain2',enable_events=True)
            ],
        [sg.Text('')],
        [sg.Text('Balance While Auto',size=(18,1),font=('Helvetica',15), text_color='yellow')],
        [sg.Text('Red',size=(10,1),font=('Helvetica',15), text_color='orange'),
        ...
        [sg.Text(' ')],
        [sg.Text(' '*110), sg.Button('Apply', size=(10,1),  font=('Helvetica',12),key='aplly_param_camera2',enable_events=True),sg.Button('Save', size=(10,1),  font=('Helvetica',12),key='save_param_camera2',enable_events=True)] 
    ] 
...
result2 = model1(img2_test,416,0.25) 
...
while True:
    ...
    task_camera1_no_plc(model=model1,size= values['imgsz1'],conf= values['conf_thres1']/100)
    task_camera2_no_plc(model=model2,size= values['imgsz2'],conf= values['conf_thres2']/100)
    ...
    if event == 'Webcam2':
        ...
        recording2 = True
        window['Continue2'].update(disabled=False)
    ...
    if recording1:
        if have_model1 == True:
            ...
            if img1_orgin is not None:
                result1 = model1(img1_orgin,size= values['imgsz1'],conf = values['conf_thres1']/100, max_det= values['max_det1'], classes= values_classes1)
    ...
    if recording2:
        if have_model2 == True:
            ...
            if img2_orgin is not None:
                result2 = model2(img2_orgin,size= values['imgsz2'],conf = values['conf_thres2']/100, max_det= values['max_det2'], classes= values_classes2)
    ...
    if event == 'choose_exposure1':
        ...
        set_exposure_or_gain("ExposureTime","ExposureTimeRaw",values['exposure_input1'])
    ...
    if event == 'choose_gain1':
        ...
        set_exposure_or_gain("Gain","GainRaw",values['gain_input1'])
    ...
    if event == 'aplly_param_camera1':
        set_exposure_or_gain("ExposureTime","ExposureTimeRaw",values['exposure_slider1'])
        set_exposure_or_gain("Gain","GainRaw",values['gain_slider1'])
    ...
    if event == 'save_param_camera1':
        save_param_camera(values['exposure_slider1'],values['gain_slider1'],values['red_slider1'],values['greenr_slider1'],values['greenb_slider1'],values['green_slider1'],values['blue_slider1'],'static/param_camera1.txt')
    ...
    if event == 'choose_exposure2':
        ...
        set_exposure_or_gain("ExposureTime","ExposureTimeRaw",values['exposure_input2'])
    ...
    if event == 'choose_gain2':
        ...
        set_exposure_or_gain("Gain","GainRaw",values['gain_input2'])
    ...
    if event == 'aplly_param_camera2':
        set_exposure_or_gain("ExposureTime","ExposureTimeRaw",values['exposure_slider2'])
        set_exposure_or_gain("Gain","GainRaw",values['gain_slider2'])
    ...
    if event == 'save_param_camera2':
        save_param_camera(values['exposure_slider2'],values['gain_slider2'],values['red_slider2'],values['greenr_slider2'],values['greenb_slider2'],values['green_slider2'],values['blue_slider2'],'static/param_camera2.txt')
        sg.popup('Saved successed',font=('Helvetica',15), text_color='yellow',keep_on_top= True)
    ...
    if event == 'SaveData1':
        save_param_model1(values['conf_thres1'],values['area_nutme1'], values['area_divat1'],values['area_me1'],values['y_namchamcao1'],values['area_traybactruc1'],values['area_divatduoi1'] ,values['y_kimnamcham1'])
    ...
    if event == 'SaveData2':
        save_param_model2(values['conf_thres2'] ,values['area_nutme2'], values['area_divat2'],values['area_me2'])
