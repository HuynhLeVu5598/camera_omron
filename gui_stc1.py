...
def make_window(theme):
    ...
    layout_main = [
        ...
        sg.Frame('',[
            ...
            [
                ...
                [sg.Text('Classes1', size=(12,1),font=('Helvetica',15), text_color='yellow',), sg.Listbox(values=CLASSES1,size=(23,3), text_color= 'aqua',select_mode= sg.LISTBOX_SELECT_MODE_MULTIPLE, key='classes1',enable_events=True), 
                    sg.Checkbox('Remove all',size= (9,1), font= ('Helvetica',15),text_color='yellow', key= 'remove_all_listbox1')],
        ...
        sg.Frame('',[
            ...
            [sg.Frame('',
            [
                [sg.Text('Weights2', size=(12,1), font=('Helvetica',15),text_color='yellow'), sg.Input(size=(19,1), font=('Helvetica',12), key='file_weights2',readonly= True, text_color='navy',enable_events= True),
                sg.Frame('',[
                    [sg.FileBrowse(file_types= file_weights, size=(12,1), font=('Helvetica',10),key= 'file_browse2',enable_events=True)]
                ], relief= sg.RELIEF_FLAT)],
                [sg.Text('Size2', size=(12,1),font=('Helvetica',15), text_color='yellow'),sg.InputCombo((416,512,608,896,1024,1280,1408,1536),size=(20,20),font=('Helvetica',11),default_value=416,key='imgsz2')],
                [sg.Text('Confidence2',size=(12,1),font=('Helvetica',15), text_color='yellow'), sg.Slider(range=(1,100),orientation='h',size=(20,20),font=('Helvetica',11), default_value=25, key= 'conf_thres2')],
                [sg.Text('Max detection2', size=(12,1), font=('Helvetica',15), text_color='yellow'), sg.Spin(values=list_spin, initial_value=10, size=(20,20),font=('Helvetica',11),key='max_det2')],
                [sg.Text('Classes2', size=(12,1),font=('Helvetica',15), text_color='yellow',), sg.Listbox(values=CLASSES1,size=(23,3), text_color= 'aqua',select_mode= sg.LISTBOX_SELECT_MODE_MULTIPLE, key='classes2',enable_events=True), 
                    sg.Checkbox('Remove all',size= (9,1), font= ('Helvetica',15),text_color='yellow', key= 'remove_all_listbox2')],
            ...
            sg.Frame('',
            [
                [sg.Checkbox('Continous2', size=(10,1),font=('Helvetica',15),text_color='yellow',key= 'Continous2',disabled=True)], 
                [sg.Combo(values=(1,10,100,1000), default_value=1, size=(4,1),font=('Helvetica',12),readonly=True,key='time_continous2',enable_events= True), sg.Text('ms', font=('Helvetica',15), text_color='yellow')]
            ],expand_y= True, relief= sg.RELIEF_FLAT,)
            ]
        ], expand_y= True),
        ...
        #4
        sg.Frame('',[
            [sg.Button('Webcam2', size=(8,1),  font=('Helvetica',14))],
            [sg.Text('')],
            ...
            [sg.Text('')],
            [sg.Button('Continue2', size=(8,1), font=('Helvetica',14),disabled= True)],
            [sg.Text('')],
            [sg.Button('Pic2', size=(8,1), font=('Helvetica',14))],
            [sg.Text('')],
            [sg.Button('Detect2', size=(8,1), font=('Helvetica',14))],
        ],expand_y=True,element_justification='center',expand_x=True)]
    ]
    ...
    #window = sg.Window('HuynhLeVu', layout, location=(0,0),right_click_menu=right_click_menu,size = (10000,10000 ))
...
while True:
    ...
    if recording2:
        if have_model2 == True:
            img2_org = my_callback.image
            img2_org = cv2.resize(img2_org,(640,480))
            if img2_org is not None:
    ...
    if event == 'Change1':
        try:
            ...
            window['file_weights1'].update(value = '')
            sg.popup('Error model',font=('Helvetica',15), text_color='yellow',keep_on_top= True)

    if values['remove_all_listbox1'] == True:
