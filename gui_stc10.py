...
def save_param_model1(weight1,weight2,size,conf,nut_me,divat,me,namchamcao,traybactruc,divatduoi,kimcaomax,kimcaomin):
    line1 = 'A22' + '=' + str(weight1)
    line2 = 'A19' + '=' + str(weight2)
...
def save_param_model2(weight1,weight2,size,conf,nut_me,divat,me):
    line1 = 'A22' + '=' + str(weight1)
    line2 = 'A19' + '=' + str(weight2)
...
def make_window(theme):
    ...
    layout_parameter_model = [
        ...
        sg.Frame('',[
            [sg.Frame('',
            [
                [sg.Text('Weights A22', size=(12,1), font=('Helvetica',15),text_color='yellow'), sg.Input(size=(52,1), font=('Helvetica',12), key='file_weights_A22_2',readonly= True, text_color='navy',default_text=list_param_model2[0],enable_events= True),
                sg.Frame('',[
                    [sg.FileBrowse(file_types= file_weights, size=(12,1), font=('Helvetica',10),key= 'file_browse_A22_2',enable_events=True, disabled=True)]
                ], relief= sg.RELIEF_FLAT)],
                [sg.Text('Weights A19', size=(12,1), font=('Helvetica',15),text_color='yellow'), sg.Input(size=(52,1), font=('Helvetica',12), key='file_weights_A19_2',readonly= True, text_color='navy',default_text=list_param_model2[1],enable_events= True),
                sg.Frame('',[
                    [sg.FileBrowse(file_types= file_weights, size=(12,1), font=('Helvetica',10),key= 'file_browse_A19_2',enable_events=True, disabled=True)]
                ], relief= sg.RELIEF_FLAT)],
        ...
        sg.Frame('',[
            [sg.Frame('',
            [
                [sg.Text('Weights A22', size=(12,1), font=('Helvetica',15),text_color='yellow'), sg.Input(size=(52,1), font=('Helvetica',12), key='file_weights_A22_1',readonly= True, text_color='navy',default_text=list_param_model1[0],enable_events= True),
                sg.Frame('',[
                    [sg.FileBrowse(file_types= file_weights, size=(12,1), font=('Helvetica',10),key= 'file_browse_A22_1',enable_events=True,disabled=True )]
                ], relief= sg.RELIEF_FLAT)],
                [sg.Text('Weights A19', size=(12,1), font=('Helvetica',15),text_color='yellow'), sg.Input(size=(52,1), font=('Helvetica',12), key='file_weights_A19_1',readonly= True, text_color='navy',default_text=list_param_model1[1],enable_events= True),
                sg.Frame('',[
                    [sg.FileBrowse(file_types= file_weights, size=(12,1), font=('Helvetica',10),key= 'file_browse_A19_1',enable_events=True,disabled=True )]
                ], relief= sg.RELIEF_FLAT)],
    ...
    while True:
        ...
        if event =='Administrator':
            ...
            if password == login_password:
                ...
                window['file_browse_A22_2'].update(disabled= False,button_color='turquoise')
                window['file_browse_A22_1'].update(disabled= False,button_color='turquoise')

                window['file_browse_A19_2'].update(disabled= False,button_color='turquoise')
                window['file_browse_A19_1'].update(disabled= False,button_color='turquoise')
...
#change model 
        ...
        if event == 'file_browse_A22_1': 
            window['file_weights_A22_1'].update(value=values['file_browse_A22_1'])
            if values['file_browse_A22_1']:
                window['Change1'].update(disabled=False)
        if event == 'file_browse_A19_1': 
            window['file_weights_A19_1'].update(value=values['file_browse_A19_1'])
            if values['file_browse_A19_1']:
                window['Change1'].update(disabled=False)

        if event == 'file_browse_A22_2':
            window['file_weights_A22_2'].update(value=values['file_browse_A22_2'])
            if values['file_browse_A22_2']:
                window['Change2'].update(disabled=False)

        if event == 'file_browse_A19_2':
            window['file_weights_A19_2'].update(value=values['file_browse_A19_2'])
            if values['file_browse_A19_2']:
                window['Change2'].update(disabled=False)
        ...
        if event == 'Change1':
            if values['change_model'] == 'A22':
                model1= torch.hub.load('./levu','custom',path=values['file_weights_A22_1'],source='local',force_reload=False)
            if values['change_model']  == 'A19':
                model1= torch.hub.load('./levu','custom',path=values['file_weights_A19_1'],source='local',force_reload=False)
            #window['Detect1'].update(disabled= False)

        if event == 'Change2':
            if values['change_model']  == 'A22':
                model2= torch.hub.load('./levu','custom',path=values['file_weights_A22_2'],source='local',force_reload=False)
            elif values['change_model']  == 'A19':
                model2= torch.hub.load('./levu','custom',path=values['file_weights_A19_2'],source='local',force_reload=False)
            #window['Detect2'].update(disabled= False)
        ...
        if event == 'SaveData1':
            save_param_model1(values['file_weights_A22_1'], values['file_weights_A19_1'], values['imgsz1'],values['conf_thres1'],values['area_nutme1'], values['area_divat1'],values['area_me1'],values['y_namchamcao1'],values['area_traybactruc1'],values['area_divatduoi1'] ,values['ymin_kimnamcham1'],values['ymax_kimnamcham1'])
            sg.popup('Saved param model 1 successed',font=('Helvetica',15), text_color='green',keep_on_top= True)


        if event == 'SaveData2':
            save_param_model2(values['file_weights_A22_2'],values['file_weights_A19_2'], values['imgsz2'],values['conf_thres2'] ,values['area_nutme2'], values['area_divat2'],values['area_me2'])
